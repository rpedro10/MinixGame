...
#define TIMER_HOOK_ID 		2
#define KBD_HOOK_ID 		0
#define MOUSE_HOOK_ID 		1
...
#define ENABLE_SMODE		0xEA
#define STATUS_REQUEST		0xE9
#define ENABLE_REMOTE_MODE	0xF0
...
#define mode3 				0x105
#define mode4 				0x107
#define TRANSPARENT_COLOUR	USHRT_MAX
