...
specifies the offset in bytes from the bitmapfileheader to the bitmap bits \index{Bitmap\+File\+Header@{Bitmap\+File\+Header}!reserved@{reserved}}
...
reserved; must be 0 \index{Bitmap\+File\+Header@{Bitmap\+File\+Header}!size@{size}}
...
specifies the size in bytes of the bitmap file \index{Bitmap\+File\+Header@{Bitmap\+File\+Header}!type@{type}}
