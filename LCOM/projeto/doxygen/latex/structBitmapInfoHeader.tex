...
specifies the number of bit per pixel \index{Bitmap\+Info\+Header@{Bitmap\+Info\+Header}!compression@{compression}}
...
specifies the type of compression \index{Bitmap\+Info\+Header@{Bitmap\+Info\+Header}!height@{height}}
...
specifies height in pixels \index{Bitmap\+Info\+Header@{Bitmap\+Info\+Header}!image\+Size@{image\+Size}}
...
size of image in bytes \index{Bitmap\+Info\+Header@{Bitmap\+Info\+Header}!important\+Colors@{important\+Colors}}
...
number of colors that are important \index{Bitmap\+Info\+Header@{Bitmap\+Info\+Header}!n\+Colors@{n\+Colors}}
...
number of colors used by the bitmap \index{Bitmap\+Info\+Header@{Bitmap\+Info\+Header}!planes@{planes}}
...
specifies the number of color planes, must be 1 \index{Bitmap\+Info\+Header@{Bitmap\+Info\+Header}!size@{size}}
...
specifies the number of bytes required by the struct \index{Bitmap\+Info\+Header@{Bitmap\+Info\+Header}!width@{width}}
...
specifies width in pixels \index{Bitmap\+Info\+Header@{Bitmap\+Info\+Header}!x\+Resolution@{x\+Resolution}}
...
number of pixels per meter in x axis \index{Bitmap\+Info\+Header@{Bitmap\+Info\+Header}!y\+Resolution@{y\+Resolution}}
